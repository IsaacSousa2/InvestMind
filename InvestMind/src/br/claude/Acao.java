...
public class Acao {
	...
	public Acao(String setor, double dividendoAnual) {
	...
	public void calcularRentabilidadeMensal() {
		this.setRentabilidadeMensal(dividendoAnual / 12);
	}
